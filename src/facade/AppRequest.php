...
/**
 * @see \huikedev\huike_base\request\AppRequest
 * @package huikedev\huike_base\facade
 * @mixin \huikedev\huike_base\request\AppRequest
 ...
 * @method static bool has(string $name, string $type = 'param', bool $checkEmpty = true) 是否存在某个请求参数
 * @method static string getTokenName() 获取token名称
 * @method static string getToken() 获取token的值
 ...
 * @method static float safeFloat(string $name)
 * @method static string safeString(string $name)
 * @method static array safeArray(string $name)
 * @method static int pageSize(int $default = 10)
 * @method static int current(int $default = 1)
...
class AppRequest extends Facade
{
    ...
    {
        return \huikedev\huike_base\request\AppRequest::class;
    }
}